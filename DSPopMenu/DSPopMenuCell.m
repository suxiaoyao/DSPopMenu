...
#define kIconLeftMargin DSWIDTH_SCALE(20)
#define kIconWidthAndHeight DSHEIGHT_SCALE(20)
#define kTextLeftMargin DSWIDTH_SCALE(10)
#define kIconRightMargin DSWIDTH_SCALE(15)
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.titleLabel.font = [UIFont systemFontOfSize:DSHEIGHT_SCALE(14.0)];
